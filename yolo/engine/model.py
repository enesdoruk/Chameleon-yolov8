...
import yolo  # noqa
from yolo.train import DetectionTrainer
from yolo.val import DetectionValidator
from yolo.predict import DetectionPredictor
from nn.tasks import (DetectionModel, attempt_load_one_weight, guess_model_task, nn, yaml_model_load)
...
TASK_MAP = {
    'detect': [
        DetectionModel, DetectionTrainer, DetectionValidator,
        DetectionPredictor]}
