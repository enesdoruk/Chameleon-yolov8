...
class DetectionTrainer(BaseTrainer):
    ...
    def get_validator(self):
        ...
        self.loss_names = 'box_loss', 'cls_loss', 'dfl_loss', 'cdan_loss'
    ...
    def criterion(self, preds, batch, cdan_loss=None):
        ...
        if cdan_loss is not None:
            return self.compute_loss(preds, batch, cdan_loss)
        else:
...
class Loss:
    ...
    def __call__(self, preds, batch, cdan_loss=None):
