...
class MultiScaleAlig(nn.Module):
    def __init__(self) -> None:
        ...
        self.br2_1 = nn.Conv2d(512, 512, kernel_size=3, stride=1, padding=2)
        self.prelu2_1 = nn.PReLU()
        self.mpool2_1 = nn.MaxPool2d(kernel_size=3, stride=2)
        
        self.br3_1 = nn.Conv2d(256, 256, kernel_size=3, stride=1, padding=1)
        self.prelu3_1 = nn.PReLU()
        self.mpool3_1 = nn.MaxPool2d(kernel_size=3, stride=4)
